...
function VoteList({ selectedVotes, removeVote }) {
  ...
  return (
    <div className='w-[28vh] px-3'>
      <div className='w-full h-full rounded-lg border border-gray-400'>
        ...
        <h1 className='text-blue-950 text-xl font-bold p-3 border-b border-gray-400'>
          Your Votes
        </h1>
        ...
        <div className='p-3 h-[80vh] overflow-y-auto space-y-3'>
          ...
          {voteEntries.length === 0 ? (
            <div className='p-4 bg-white rounded-lg text-center text-gray-600'>
              ...
              <p className='text-sm'>
                Click a candidate to preview your vote here before submitting.
              </p>
            </div>
          ) : (
              ...
              >
                ...
                <div className='flex flex-col justify-between items-center gap-3'>
                  <div className='text-center flex-1'>
                    <p className='text-blue-950 font-bold text-[15px]'>
                      {position}
                    </p>
                    ...
                    <button
                    onClick={() => removeVote(position)}
                    className='bg-red-400 border border-red-500 hover:bg-red-600 trnasition-colors duration-300 text-white font-bold text-[10px] w-full  py-1 '
                  >
                    Remove
                  </button>
